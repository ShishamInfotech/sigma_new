...
import '../pages/pdf/pdf_viewer.dart' show PDFViewerPage;


class SigmaTeam extends StatefulWidget {
  const SigmaTeam({super.key});

  @override
  State<SigmaTeam> createState() => _SigmaTeamState();
}

class _SigmaTeamState extends State<SigmaTeam> {
  ...
  Future<void> requestPermissionAndLoad() async {
    if (await Permission.storage.request().isGranted) {
      ...
      final baseDir = Directory("${sigmaPath}/sigma_team");
